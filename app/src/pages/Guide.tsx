...
const posterSteps = [
  {
    ...
    body: "Tap Post a Task from anywhere on the site. Describe the job in a few words and pick a category — Sirius Jobs automatically decides whether it's a Bid & Escrow job or a Get Quotes trade job based on the category.",
    note: (
      <>
        <Tag className="mt-0.5 h-3.5 w-3.5 shrink-0 text-primary" />
        <span>
          <b className="text-gray-900">Errands, cleaning, small repairs</b> → Bid &amp; Escrow.{' '}
          <b className="text-gray-900">Plumbing, electrical, building work</b> → Get Quotes.
        </span>
      </>
    ),
  },
  {
    ...
    body: "Set where the job is, a fuller description, and your budget. If the tasker might need to buy something (like groceries), set your budget to cover both labor and a rough estimate of the items — you'll settle exact purchases with the tasker directly once they're on-site.",
  },
  {
    icon: Users,
    title: 'Review bids as they come in',
    body: 'Taskers submit bids with their price and a short message. Tap a bidder\'s name to see their rating, completed-job count, and past reviews before deciding.',
  },
  {
    icon: Lock,
    title: 'Accept a bid — payment is held, not sent',
    body: "Accepting a bid takes you to secure checkout for the bid amount. Your money is held safely — the tasker isn't paid yet. It only releases once you confirm the job is done.",
    note: (
      <>
  ...
  },
  {
    ...
    body: "Once a bid's accepted, in-app chat opens with your tasker. If the job needs a purchase, they can send you a photo of the item and price right in the chat, and you can approve it before they buy.",
  },
  {
    icon: CheckCircle2,
    title: 'Confirm complete, then rate',
    body: "When the work is done, tap Mark Complete to release payment to the tasker immediately, then leave a star rating and short review — this is what future posters see on their profile.",
    note: (
      <>
...
const taskerSteps = [
  {
    ...
    body: 'From Browse Tasks, filter by location and category. Each listing shows the path — Bid & Escrow or Get Quotes — and the budget range, so you know upfront what kind of job it is.',
  },
  {
    icon: Tag,
    title: 'Bid & Escrow jobs — place a bid',
    body: "Open the task and submit your price for the labor, plus an optional message. If the job needs materials or supplies, mention that in your message — you and the poster agree on those separately once you're talking.",
  },
  {
    icon: Lock,
    title: 'Get Quotes jobs — pay to unlock the lead',
    body: "Trade jobs don't use bidding. Pay a small one-time fee (5% of the job's budget, ₦500–₦10,000) to unlock in-app chat with the poster, then quote and arrange the job directly with them.",
    note: (
      <>
  ...
  },
  {
    ...
    body: 'Once your bid\'s accepted (or your lead\'s purchased), chat opens with the poster. If you need to buy something for the job, message them the item and price — with a photo if you can — and let them pay the seller directly before you complete the purchase.',
  },
  {
    icon: Wallet,
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          <div className="rounded-2xl border border-gray-200/70 bg-white p-5 shadow-sm">
            ...
            <p className="mt-2 text-sm text-gray-600">
              ...
              repairs, moving, furniture assembly. Taskers bid a price, you accept one, payment is
              held safely and released only once you confirm the job's done.
            </p>
          </div>
          <div className="rounded-2xl border border-gray-200/70 bg-white p-5 shadow-sm">
